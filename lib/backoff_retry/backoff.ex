defmodule BackoffRetry.Backoff do
  @moduledoc """
  Stream-based backoff strategies for `BackoffRetry`.
  ...
  Strategies compose naturally via pipes:
      ...
      |> BackoffRetry.Backoff.jitter(0.25)
      |> BackoffRetry.Backoff.cap(10_000)
  ...
  ## Examples
      ...
      iex> BackoffRetry.Backoff.exponential() |> Enum.take(4)
      [100, 200, 400, 800]

      iex> BackoffRetry.Backoff.exponential(base: 50, multiplier: 3) |> Enum.take(3)
      [50, 150, 450]
  ...
  ## Examples
      ...
      iex> BackoffRetry.Backoff.linear() |> Enum.take(4)
      [100, 200, 300, 400]

      iex> BackoffRetry.Backoff.linear(base: 50, increment: 50) |> Enum.take(3)
      [50, 100, 150]
  ...
  ## Examples
      ...
      iex> BackoffRetry.Backoff.constant() |> Enum.take(3)
      [100, 100, 100]

      iex> BackoffRetry.Backoff.constant(delay: 500) |> Enum.take(3)
      [500, 500, 500]
  ...
  ## Examples
      ...
      iex> BackoffRetry.Backoff.exponential(base: 1000) |> BackoffRetry.Backoff.cap(5000) |> Enum.take(5)
